...
`);
 ...
 .addField("⦁`All types of codes in Cobra Codes™ Server 💬`⦁",' ‎ ')
...
if(!message.channel.guild) return message.reply(' ');
  ...
  let rank = message.guild.member(message.author).roles.find('name', '° Cobra » Support', '° Cobra » Support Plus');
...
client.on ("guildMemberAdd", member => {
   ...
   var role = member.guild.roles.find ("name", " ° Cobra » Member");
   member.addRole (role);
...
if(!message.channel.guild) return message.reply(' ');
  ...
  let rank = message.guild.member(message.author).roles.find('name', ' ° Cobra » Support ');
...
if(!message.channel.guild) return message.reply(' ');
  ...
  let jscodes = message.guild.channels.find(`name`, " ➾codes➺css");
...
if(!message.channel.guild) return message.reply(' ');
  ...
  let jscodes = message.guild.channels.find(`name`, " ➾codes➺php ");
